...
It requires nothing but a modern web browser - no installation, no admin privileges, and no internet.<br>
It works on Windows, Android, macOS, and Linux. 32 and 64-bit. <a href=https://raw.githubusercontent.com/OfflineBay/TheOfflineBay/master/docs/Search%20Results.png>Screenshot1</a> <a href=https://raw.githubusercontent.com/OfflineBay/TheOfflineBay/master/docs/Search%20Result%20Details.png>Screenshot2</a>
...
- All (Everything - 32 million)
- All Alive (Everything alive - 5 million) (Recommended)
...
Use the alive variant unless you need dead torrents due to performance loss with the larger database.<br>
...
We get over 50 million unique hashes from the above sources.  Due to lack of searchable titles, only 32 million are available through The Offline Bay.
...
- Release a CSV/sqlite3 dump of our database (50 million torrents)
- Bitcoin integration to be updatable and domainless (this is 90% developed, built around <a href=https://github.com/elendirx/web2web>web2web</a>).
